...
public class ReportBudgetDefinitionTest extends
		AbstractReportDefinitionTest<ReportBudget> {

	/**
	 * C'tor
	 */
	public ReportBudgetDefinitionTest() {
		super(ReportBudget.class,
	...
	protected String[] retrievePropertiesToBeSelected() {
		return new String[] {
				...
				"Conversions", "Ctr", "AverageCpm", "AverageCpc",
				...
				"BudgetReferenceCount", "IsBudgetExplicitlyShared", "Period" };
	}
