...
public class ReportAccountDefinitionTest extends
		AbstractReportDefinitionTest<ReportAccount> {
	...
	protected void testFirstEntry(ReportAccount first) {
		...
		Assert.assertEquals("Lucotte - Vernoil- Le-fourrier",
				first.getAccountDescriptiveName());
	...
	protected void testLastEntry(ReportAccount last) {
		...
		Assert.assertEquals("Lucotte - Vernoil- Le-fourrier",
				last.getAccountDescriptiveName());
