...
public class ReportCampaignNegativeKeywordDefinitionTest extends
		AbstractReportDefinitionTest<ReportCampaignNegativeKeyword> {
	...
	public ReportCampaignNegativeKeywordDefinitionTest() {
		...
		super(
				ReportCampaignNegativeKeyword.class,
	...
	protected String[] retrievePropertiesToBeSelected() {
		return new String[] { "CampaignId", "Id", "KeywordMatchType",
				"KeywordText", "IsNegative" };
	}
}