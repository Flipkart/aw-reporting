...
public class ReportAdExtensionDefinitionTest extends
		AbstractReportDefinitionTest<ReportAdExtension> {
	...
	protected String[] retrievePropertiesToBeSelected() {
		...
		return new String[] { "Cost", "Clicks", "Impressions", "Conversions",
				"Ctr", "AverageCpm", "AverageCpc", "AveragePosition", "Date",
				"AdNetworkType1", "AdNetworkType2", "CampaignId",
				"AdExtensionId", "AdExtensionType", "Status", "ApprovalStatus",
